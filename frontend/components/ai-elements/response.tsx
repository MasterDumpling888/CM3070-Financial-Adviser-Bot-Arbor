...
const components: Options['components'] = {
  p: ({ node, children, className, ...props }) => (
    <p className={cn(' my-0.5 leading-relaxed', className)} {...props}>
      {children}
    </p>
  ),
  ol: ({ node, children, className, ...props }) => (
    <ol className={cn('ml-4 list-outside list-decimal leading-relaxed', className)} {...props}>
      {children}
    </ol>
  ),
  ...
  ul: ({ node, children, className, ...props }) => (
    <ul className={cn('ml-4 list-outside list-disc leading-relaxed', className)} {...props}>
      {children}
    </ul>
  ),
  ...
  h1: ({ node, children, className, ...props }) => (
    <h1
      className={cn('mt-6 mb-2 font-bold', className)}
      {...props}
    >
      {children}
    </h1>
  ...
  h2: ({ node, children, className, ...props }) => (
    <h2
      className={cn('mt-6 mb-2 font-bold text-3xl', className)}
      {...props}
    >
      {children}
    </h2>
  ...
  h3: ({ node, children, className, ...props }) => (
    <h3 className={cn('mt-6 mb-2 font-bold', className)} {...props}>
      {children}
    </h3>
  ),
  h4: ({ node, children, className, ...props }) => (
    <h4 className={cn('mt-6 mb-2 font-bold', className)} {...props}>
      {children}
    </h4>
  ),
  h5: ({ node, children, className, ...props }) => (
    <h5
      className={cn('mt-6 mb-2 font-bold text-lg', className)}
      {...props}
    >
      {children}
    </h5>
  ...
  h6: ({ node, children, className, ...props }) => (
    <h6 className={cn('mt-6 mb-2 font-bold', className)} {...props}>
      {children}
    </h6>
  ),
    ...
    return (
      ...
      >
        <HardenedMarkdown
          ...
          {...options}
        >
          {typeof parsedChildren === 'object' ? JSON.stringify(parsedChildren) : parsedChildren}
        </HardenedMarkdown>
      </div>
    );
  },
